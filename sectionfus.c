...
void fnc_fus(ELF_STRUCT file1, ELF_STRUCT file2, ELF_STRUCT * fileres, sect_tab * tab, int indice_s1, int indice_s2, int indice_sfinal, int * place){
	...
	*place = *place+tab[indice_sfinal].size1+tab[indice_sfinal].size2;
	...
	fileres->shtab[indice_sfinal].sh_name=file1.shtab[indice_sfinal].sh_name;
	fileres->shtab[indice_sfinal].sh_type=file1.shtab[indice_sfinal].sh_type;
	fileres->shtab[indice_sfinal].sh_flags=file1.shtab[indice_sfinal].sh_flags;
	fileres->shtab[indice_sfinal].sh_addr=file1.shtab[indice_sfinal].sh_addr;
	...
	fileres->shtab[indice_sfinal].sh_link=file1.shtab[indice_sfinal].sh_link;
	fileres->shtab[indice_sfinal].sh_info=file1.shtab[indice_sfinal].sh_info;
	fileres->shtab[indice_sfinal].sh_addralign=file1.shtab[indice_sfinal].sh_addralign;
	fileres->shtab[indice_sfinal].sh_entsize=file1.shtab[indice_sfinal].sh_entsize;
...
void fnc_non_fus(ELF_STRUCT file1, ELF_STRUCT * fileres, sect_tab * tab, int indice_s1, int indice_sfinal, int * place){
	...
	*place= *place+tab[indice_sfinal].size1;
	...
	fileres->shtab[indice_sfinal].sh_addr=file1.shtab[indice_sfinal].sh_addr;
	fileres->shtab[indice_sfinal].sh_offset=tab[indice_sfinal].offset;
	fileres->shtab[indice_sfinal].sh_size=file1.shtab[indice_sfinal].sh_size;
	fileres->shtab[indice_sfinal].sh_link=file1.shtab[indice_sfinal].sh_link;
	fileres->shtab[indice_sfinal].sh_info=file1.shtab[indice_sfinal].sh_info;
	fileres->shtab[indice_sfinal].sh_addralign=file1.shtab[indice_sfinal].sh_addralign;
	fileres->shtab[indice_sfinal].sh_entsize=file1.shtab[indice_sfinal].sh_entsize;
...
void fnc_fus_2(ELF_STRUCT file1, ELF_STRUCT file2, ELF_STRUCT * fileres, sect_tab * tab, int indice_s1, int indice_s2, int indice_sfinal, int * place){
	...
	*place = *place+tab[indice_sfinal].size2;
	...
	fileres->shtab[indice_sfinal].sh_name=file2.shtab[indice_sfinal].sh_name;
	fileres->shtab[indice_sfinal].sh_type=file2.shtab[indice_sfinal].sh_type;
	fileres->shtab[indice_sfinal].sh_flags=file2.shtab[indice_sfinal].sh_flags;
	fileres->shtab[indice_sfinal].sh_addr=file2.shtab[indice_sfinal].sh_addr;
	fileres->shtab[indice_sfinal].sh_offset=tab[indice_sfinal].offset;
	fileres->shtab[indice_sfinal].sh_size=file2.shtab[indice_sfinal].sh_size;
	fileres->shtab[indice_sfinal].sh_link=file2.shtab[indice_sfinal].sh_link;
	fileres->shtab[indice_sfinal].sh_info=file2.shtab[indice_sfinal].sh_info;
	fileres->shtab[indice_sfinal].sh_addralign=file2.shtab[indice_sfinal].sh_addralign;
	fileres->shtab[indice_sfinal].sh_entsize=file2.shtab[indice_sfinal].sh_entsize;
}
